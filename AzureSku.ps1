$Skus = @(
    ...
    [ordered]@{
        ...
        SkuFriendlyName = 'Azure Active Directory Basic'
        ServicePlans    = @(
            [ordered]@{
    ...
    [ordered]@{
        ...
        SkuFriendlyName = 'Microsoft Flow Free'
        Serviceplans    = @(
            [ordered]@{
                ServicePlanId           = '113feb6c-3fe4-4440-bddc-54d774bf0318'
                ServicePlanName         = 'EXCHANGE_S_FOUNDATION'
    ...
    [ordered]@{
        ...
        SkuFriendlyName = 'Exchange Online (Plan 1)'
        Serviceplans    = @(
    ...
    [ordered]@{
        ...
        SkuFriendlyName = 'Microsoft Teams Trial'
        Serviceplans    = @(
    ...
    [ordered]@{
        ...
        SkuFriendlyName = 'Visio Online Plan 2'
        Serviceplans    = @(
            [ordered]@{
    ...
    [ordered]@{
        ...
        SkuFriendlyName = 'Office 365 ProPlus'
        Serviceplans    = @(
            [ordered]@{
            ...
            [ordered]@{
                ...
                ServicePlanName         = 'ONEDRIVESTANDARD'
                ServicePlanFriendlyName = ''
            }
            [ordered]@{
    ...
    [ordered]@{
        ...
        SkuFriendlyName = 'Office 365 Business Essentials'
        Serviceplans    = @(
            [ordered]@{
...
$Skus | ConvertTo-Json -Depth 3 | Out-File -FilePath $OutPathJson -Encoding utf8